...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_category'])) {
        ...
        $check = $db->prepare("SELECT id FROM categories WHERE name = ? AND category_type = 'asset'");
        ...
        if ($check->num_rows > 0) {
            ...
            $stmt = $db->prepare("INSERT INTO categories (name, category_type) VALUES (?, 'asset')");
        ...
        $check = $db->prepare("SELECT id FROM categories WHERE name = ? AND category_type = 'asset' AND id != ?");
        ...
        if ($check->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                $error = "Error updating category: " . $db->error;
            }
        }
...
$categories = $db->query("SELECT * FROM categories WHERE category_type = 'asset' ORDER BY id ASC")->fetch_all(MYSQLI_ASSOC);
?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="manage_assets_category.php" class="nav-link active">Asset Categories</a></li>
...
<div class="container" style="margin-top: 80px;">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5>Existing Asset Categories</h5>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <button type="submit" name="edit_category" class="btn btn-warning btn-sm">Edit</button>
                                        </form>
                                        <!-- Delete form -->
                                        <form method="POST" style="display:inline;">
                                            <input type="hidden" name="id" value="<?php echo $category['id']; ?>">
